    ...
    return (
        <DashboardLayout onLogout={onLogout}>
            ...
            <style>{`
                ...
                .status-pill.active { background: rgba(20, 180, 89, 0.2); color: #14C759; border: 1px solid rgba(20, 180, 89, 0.4); }
                .status-pill.inactive { background: rgba(255, 107, 107, 0.2); color: #FFB3B3; border: 1px solid rgba(255, 107, 107, 0.4); }
