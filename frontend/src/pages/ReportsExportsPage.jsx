    ...
    return (
        <DashboardLayout onLogout={onLogout}>
            ...
            <style>{`
                ...
                .status-pill.completed { background: rgba(20, 180, 89, 0.2); color: #14C759; border: 1px solid rgba(20, 180, 89, 0.4); }
                .status-pill.processing { background: rgba(200, 169, 81, 0.15); color: #C8A951; border: 1px solid rgba(200, 169, 81, 0.3); }
